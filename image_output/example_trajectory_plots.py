...
poses_three = file_interface.read_tum_trajectory_file(file_path_three)
x_three = poses_two.positions_xyz[:, 0]
y_three = poses_two.positions_xyz[:, 2]
#############################
# configure plot
...
plt.plot(x_three,y_three,  color="#E37222", linewidth=2)


label_one = "          SLAM at 1x speed"
label_two = "Localization at 2x speed"
label_three = "ground truth"
